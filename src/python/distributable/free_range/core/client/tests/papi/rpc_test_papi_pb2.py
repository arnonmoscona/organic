...
_RPCREQUESTA = _descriptor.Descriptor(
  name='RpcRequestA',
  full_name='free_range.client.tests.papi.RpcRequestA',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='free_range.client.tests.papi.RpcRequestA.request', index=0,
...
_RPCRESPONSEA = _descriptor.Descriptor(
  name='RpcResponseA',
  full_name='free_range.client.tests.papi.RpcResponseA',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='response', full_name='free_range.client.tests.papi.RpcResponseA.response', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
RpcRequestA = _reflection.GeneratedProtocolMessageType('RpcRequestA', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:free_range.client.tests.papi.RpcRequestA)
  ))
...
RpcResponseA = _reflection.GeneratedProtocolMessageType('RpcResponseA', (_message.Message,), dict(
  ...
  __module__ = 'free_range.core.client.tests.rpc_test_papi_pb2'
  # @@protoc_insertion_point(class_scope:free_range.client.tests.papi.RpcResponseA)
  ))
